...
import { Sprout, LogOut, LayoutDashboard, LogIn, UserPlus } from 'lucide-react';
      ...
      <nav style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
        ...
        {user ? (
          <>
            ...
            <button onClick={() => { logout(); navigate('/login'); }} className="btn btn-secondary" style={{ padding: '0.5rem 1rem', fontSize: '0.85rem' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.35rem', padding: '0.35rem 0.65rem', background: 'rgba(255, 255, 255, 0.04)', border: '1px solid var(--border-color)', borderRadius: 'var(--radius-full)', fontSize: '0.75rem' }}>
